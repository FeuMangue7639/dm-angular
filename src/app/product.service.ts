...
export class ProductService {
  private products: Product[] = [
    ...
    { id: 4, name: 'Soldats', description: 'Figurine de trente cm, édition limité avec Asterix et Obelix en tenu de soldat', price: 60, image: 'https://www.bullesenboite.com/3034-large_default/asterix-et-obelix-en-legionnaires.jpg' },
